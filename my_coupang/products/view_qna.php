...
/* echo $cnt;
exit; */
$sql = "update $table_name set qna_cnt = $cnt where idx=$b_idx;";
/* echo $sql;
exit; */
...
<body>
    ...
    <table class="board_list_set">
        <tr class="board_list_title">
            ...
            <td class="v_content"><?php echo $array["qna_name"]; ?></td>
        </tr>
        ...
        <tr class="board_view_content">
            ...
            <td class="v_content">
            <?php echo ($array["qna_date"]); ?>
            </td>
        </tr>

        <tr class="board_view_content">
            <th class="v_title">제목</th>
            <td class="v_content"><?php echo $array["qna_title"]; ?></td>
        </tr>
