        ...
        $(document).ready(function() {
            ...
            var bxSlider = $(".bx_slider").bxSlider({
                ...
                onSlideBefore: function() { // 슬라이드 전환 전 마다 콜백
                    ...
                    txt1.textContent = " slideIndex : " + bxSlider.getCurrentSlide() +
                        " / " + ($(".bx_slider").children("div").length - 1);
            ...
            $(".bx-next").hover(function() {
                $(this).css({
                    background: "url(images/main/right_icon_over_32x48.png) center no-repeat"
                })
            }, function() {
                $(this).css({
                    background: "url(images/main/right_icon_32x48.png) center no-repeat"
                });
            });
            ...
            $(".bx-prev").hover(function() {
                $(this).css({
                    background: "url(images/main/left_icon_over_32x48.png) center no-repeat"
                })
            }, function() {
                $(this).css({
                    background: "url(images/main/left_icon_32x48.png) center no-repeat"
                });
            });
...
<body>
    <div class="wrap">
        ...
        <!-- ---------------------- FOOTER ------------------------>
        <?php include "../my_coupang/inc/footer_part(index).php" ?>
    </div>
</body>
