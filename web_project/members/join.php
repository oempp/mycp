    ...
    <form name="" action="/web_project/members/insert.php" method="get" onsubmit="return formCheck()">
        <fieldset class="bg">
            ...
            <p><label for="user_id">아이디</label>
                <input class="" id="user_id" name="u_id" type="text">
                <button id="user_ck_id" type="button" onclick="chkId()">아이디 중복 확인</button>
            ...
            <p><label for="user_email1">이메일</label>
                <input class="" id="user_email1" name="u_email" type="text">@<input class="" id="user_email2" name="u_email2" value=""
                    type="text">
            ...
            <p><label for="ps_code">우편번호</label>
                ...
                <button type="button"
                    onclick="searchAddres()">주소 검색</button>
