...
<head>
    ...
    <script type="text/javascript">
        function sel_cate() {
            ...
            if (idx == 0) location.href = "list.php";
            else if (idx != 0) location.href = "list.php?cate=" + sel_cate_val;
        }
    </script>
</head>
        ...
        ?>
            <tr class="board_list_content">
                ...
                <td class="board_content_title">
                    ...
                    <?php if ($array["cate"] == "normal") echo "일반";
                    else if ($array["cate"] == "music") echo "음악";
                    else if ($array["cate"] == "movie") echo "영화"; ?>
                    <a href="view.php?b_idx=<?php echo $array["idx"]; ?>"><?php echo $array["b_title"]; ?></a>
                </td>
