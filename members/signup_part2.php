                    ...
                    <fieldset>
                        ...
                        <div class="terms_accept_bgBox">
                            <div class="ckbox_bgbox">
                                <input id="apply_all" class="ckbox_size" name="ck_all" type="checkbox" value="" onclick="return checkApply(this)">
                            ...
                            <div class="ckbox_bgbox2">
                                <ul class="select_opt_box">
                                    <li><input name="ck" id="apply_opt1" type="checkbox" value="" onclick="unCheckApply()">[필수] 만 14세 이상입니다</li>
                                    <li><input name="ck" id="apply_opt2" type="checkbox" value="" onclick="unCheckApply()">[필수] 쿠팡 이용약관 동의</li>
                                    <li><input name="ck" id="apply_opt3" type="checkbox" value="" onclick="unCheckApply()">[필수] 전자금융거래 이용약관 동의</li>
                                    <li><input name="ck" id="apply_opt4" type="checkbox" value="" onclick="unCheckApply()">[필수] 개인정보 수집 및 이용 동의</li>
                                    <li><input name="ck" id="apply_opt5" type="checkbox" value="" onclick="unCheckApply()">[필수] 개인정보 제3자 제공 동의</li>
                                    <li><input name="ck" id="apply_opt6" type="checkbox" value="" onclick="unCheckApply()">[선택] 광고성 목적의 개인정보 수집 및 이용 동의
                                    </li>
                                    <li><input name="ck" id="apply_opt7" type="checkbox" value="" onclick="unCheckApply()">[선택] 광고성 정보 수신 동의</li>
                                    <ul class="select_opt_box2">
                                        <li><input name="ck" id="apply_opt8" type="checkbox" value="" onclick="unCheckApply()">[선택] 이메일 수신 동의</li>
                                        <li><input name="ck" id="apply_opt9" type="checkbox" value="" onclick="unCheckApply()">[선택] SMS,MMS 수신 동의</li>
                                        <li><input name="ck" id="apply_opt10" type="checkbox" value="" onclick="unCheckApply()">[선택] 앱 푸시 수신 동의</li>
                                    </ul>
                                </ul>
                            </div>
