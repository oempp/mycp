    ...
    <div class="top_bg">
        ...
        <div class="top_menu">
            ...
            <?php } else if ($s_idx == 1) { ?>
                ...
                <span><b><a href="mypage.php"><?php echo $s_name; ?></a></b></span> 님 <a href="../login/logout.php">로그아웃</a>
                <a href="admin/admin.php">관리자 페이지로</a>
                <!-- 로그인 후 -->
            <?php } else { ?>
                <p>
                    <b><span><a href="mypage.php"><?php echo $s_name; ?></a></b> 님 <a href="../login/logout.php"> 로그아웃</a>
